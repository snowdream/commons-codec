...
public class HmacUtilsTest {
    ...
    public void testMd5HMac() throws IOException {
        ...
        assertEquals(STANDARD_MD5_RESULT_STRING, HmacUtils.hmacMd5Hex(STANDARD_KEY_BYTES, STANDARD_PHRASE_BYTES));
        assertEquals(STANDARD_MD5_RESULT_STRING,
    ...
    public void testSha256HMac() throws IOException {
        ...
        assertEquals(STANDARD_SHA256_RESULT_STRING,
    ...
    public void testSha384HMac() throws IOException {
        ...
        assertEquals(STANDARD_SHA384_RESULT_STRING,
    ...
    public void testSha512HMac() throws IOException {
        ...
        assertEquals(STANDARD_SHA512_RESULT_STRING,
