...
import static org.apaches.commons.codec.binary.StringUtils.getBytesUtf8;
...
public class DigestUtilsTest {
    ...
    public void testMd2HexLength() {
        ...
        String hash = DigestUtils.md2Hex(StringUtils.getBytesUtf8(hashMe));
        assertEquals(32, hash.length());

        hashMe = "length < 32";
        hash = DigestUtils.md2Hex(StringUtils.getBytesUtf8(hashMe));
        assertEquals(32, hash.length());
    }
    ...
    public void testMd2Length() {
        ...
        byte[] hash = DigestUtils.md2(StringUtils.getBytesUtf8(hashMe));
        assertEquals(16, hash.length);

        hashMe = "length < 16";
        hash = DigestUtils.md2(StringUtils.getBytesUtf8(hashMe));
        assertEquals(16, hash.length);
    }
    ...
    public void testMd5HexLength() {
        String hashMe = "this is some string that is longer than 32 characters";
        String hash = DigestUtils.md5Hex(StringUtils.getBytesUtf8(hashMe));
        assertEquals(32, hash.length());

        hashMe = "length < 32";
        hash = DigestUtils.md5Hex(StringUtils.getBytesUtf8(hashMe));
        assertEquals(32, hash.length());
    }
    ...
    public void testMd5Length() {
        String hashMe = "this is some string that is longer than 16 characters";
        byte[] hash = DigestUtils.md5(StringUtils.getBytesUtf8(hashMe));
        assertEquals(16, hash.length);

        hashMe = "length < 16";
        hash = DigestUtils.md5(StringUtils.getBytesUtf8(hashMe));
        assertEquals(16, hash.length);
    }
    ...
    public void testSha1Hex() throws IOException {
        ...
        assertEquals("a9993e364706816aba3e25717850c26c9cd0d89d", DigestUtils.sha1Hex(StringUtils.getBytesUtf8("abc")));
    ...
    assertEquals("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad",
             DigestUtils.sha256Hex(StringUtils.getBytesUtf8("abc")));
    ...
    assertEquals("cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed" +
             "8086072ba1e7cc2358baeca134c825a7",
             DigestUtils.sha384Hex(StringUtils.getBytesUtf8("abc")));
    ...
    assertEquals("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a" +
             "2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f",
             DigestUtils.sha512Hex(StringUtils.getBytesUtf8("abc")));
    ...
    public void testShaHex() throws IOException {
        ...
        assertEquals("a9993e364706816aba3e25717850c26c9cd0d89d", DigestUtils.shaHex(StringUtils.getBytesUtf8("abc")));
